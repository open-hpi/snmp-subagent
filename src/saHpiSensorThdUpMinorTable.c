...
saHpiSensorThdUpMinorTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiSensorThdUpMinorTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
saHpiSensorThdUpMinorTable_get( const char *name, int len )
{
    saHpiSensorThdUpMinorTable_context tmp;
     ...
     */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorThdUpMinorTable_get not implemented!\n" );
    return NULL;
#endif
...
init_saHpiSensorThdUpMinorTable(void)
{
     ...
     *
     * saHpiSensorThdUpMinorTable_context * new_row = create_row(index);
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorThdUpMinorTable_extract_index index list not implemented!\n" );
    return 0;
#else
...
saHpiSensorThdUpMinorTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSensorThdUpMinorType = 0;
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORTHDUPMINORTYPE:
            ...
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorThdUpMinorType));
        break;

        case COLUMN_SAHPISENSORTHDUPMINORVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorThdUpMinorValue));
        break;
...
void saHpiSensorThdUpMinorTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORTHDUPMINORTYPE:
            /** SaHpiSensorReadingType = ASN_INTEGER */
            row_ctx->saHpiSensorThdUpMinorType = *var->val.integer;
        break;

        case COLUMN_SAHPISENSORTHDUPMINORVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorThdUpMinorValue,var->val.string,var->val_len);
     ...
     * requirements here.
     */
#ifndef saHpiSensorThdUpMinorTable_CAN_MODIFY_ACTIVE_ROW
...
#endif /** saHpiSensorThdUpMinorTable_SET_HANDLING */
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPISENSORTHDUPMINORISREADABLE:
            ...
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiSensorThdUpMinorIsReadable,
        ...
        case COLUMN_SAHPISENSORTHDUPMINORISWRITABLE:
            /** TruthValue = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiSensorThdUpMinorIsWritable,
        ...
        case COLUMN_SAHPISENSORTHDUPMINORTYPE:
            /** SaHpiSensorReadingType = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiSensorThdUpMinorType,
        ...
        case COLUMN_SAHPISENSORTHDUPMINORVALUE:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         (char*)&context->saHpiSensorThdUpMinorValue,

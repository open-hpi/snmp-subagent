...
saHpiHotSwapTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiHotSwapTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
                         ...
                         saHpiHotSwapTable_context * src)
{
    ...
    dst->saHpiHotSwapResetAction = src->saHpiHotSwapResetAction;

    dst->saHpiHotSwapPowerAction = src->saHpiHotSwapPowerAction;

    memcpy( src->saHpiHotSwapRTP, dst->saHpiHotSwapRTP, src->saHpiHotSwapRTP_len );
...
saHpiHotSwapTable_create_row( netsnmp_index* hdr)
{
    ...
    /**
     ...
     ctx->saHpiHotSwapResetAction = 0;
     ctx->saHpiHotSwapPowerAction = 0;
    */
...
void saHpiHotSwapTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIHOTSWAPPREVIOUSSTATE:
            /** SaHpiHotSwapState = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiHotSwapPreviousState));
        break;
        ...
        case COLUMN_SAHPIHOTSWAPRESETACTION:
            /** INTEGER = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiHotSwapResetAction));
        break;

        case COLUMN_SAHPIHOTSWAPPOWERACTION:
            /** INTEGER = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiHotSwapPowerAction));
        break;
...
void saHpiHotSwapTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIHOTSWAPRESETACTION:
            /** INTEGER = ASN_INTEGER */
            row_ctx->saHpiHotSwapResetAction = *var->val.integer;
        break;

        case COLUMN_SAHPIHOTSWAPPOWERACTION:
            /** INTEGER = ASN_INTEGER */
            row_ctx->saHpiHotSwapPowerAction = *var->val.integer;
        break;
            ...
            netsnmp_table_request_info *table_info )
{
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIHOTSWAPPREVIOUSSTATE:
            /** SaHpiHotSwapState = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiHotSwapPreviousState,
        ...
        case COLUMN_SAHPIHOTSWAPRESETACTION:
            /** INTEGER = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiHotSwapResetAction,
                         sizeof(context->saHpiHotSwapResetAction) );
        break;
    
        case COLUMN_SAHPIHOTSWAPPOWERACTION:
            /** INTEGER = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiHotSwapPowerAction,
                         sizeof(context->saHpiHotSwapPowerAction) );
        break;

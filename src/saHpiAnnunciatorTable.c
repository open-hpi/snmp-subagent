...
saHpiAnnunciatorTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiAnnunciatorTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
saHpiAnnunciatorTable_get( const char *name, int len )
{
    saHpiAnnunciatorTable_context tmp;
     ...
     */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiAnnunciatorTable_get not implemented!\n" );
    return NULL;
#endif
...
init_saHpiAnnunciatorTable(void)
{
     ...
     *
     * saHpiAnnunciatorTable_context * new_row = create_row(index);
...
#endif /** saHpiAnnunciatorTable_SET_HANDLING */

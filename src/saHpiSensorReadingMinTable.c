...
saHpiSensorReadingMinTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSensorReadingMinType = 0;
     ctx->saHpiSensorReadingMinValue = 0;
    */
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGMINTYPE:
            ...
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorReadingMinType));
        break;

        case COLUMN_SAHPISENSORREADINGMINVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorReadingMinValue));
        break;
...
void saHpiSensorReadingMinTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGMINTYPE:
            /** SaHpiSensorReadingType = ASN_INTEGER */
            row_ctx->saHpiSensorReadingMinType = *var->val.integer;
        break;

        case COLUMN_SAHPISENSORREADINGMINVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorReadingMinValue,var->val.string,var->val_len);
            row_ctx->saHpiSensorReadingMinValue_len = var->val_len;
        break;

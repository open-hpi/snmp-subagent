...
saHpiSensorReadingMaxTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSensorReadingMaxType = 0;
     ctx->saHpiSensorReadingMaxValue = 0;
    */
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGMAXTYPE:
            ...
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorReadingMaxType));
        break;

        case COLUMN_SAHPISENSORREADINGMAXVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorReadingMaxValue));
        break;
...
void saHpiSensorReadingMaxTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGMAXTYPE:
            /** SaHpiSensorReadingType = ASN_INTEGER */
            row_ctx->saHpiSensorReadingMaxType = *var->val.integer;
        break;

        case COLUMN_SAHPISENSORREADINGMAXVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorReadingMaxValue,var->val.string,var->val_len);
            row_ctx->saHpiSensorReadingMaxValue_len = var->val_len;
        break;

...
saHpiOEMEventTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiOEMEventTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
                         ...
                         saHpiOEMEventTable_context * src)
{
    ...
    memcpy( dst->saHpiOEMEventTimestamp, src->saHpiOEMEventTimestamp, src->saHpiOEMEventTimestamp_len );
    ...
    dst->saHpiOEMEventDelete = src->saHpiOEMEventDelete;
...
saHpiOEMEventTable_extract_index( saHpiOEMEventTable_context * ctx, netsnmp_index * hdr )
{
    ...
    netsnmp_variable_list var_saHpiOEMEventTimestamp;
    int err;
     ...
     */
       ...
       var_saHpiEventHistorical.next_variable = &var_saHpiOEMEventTimestamp;

       memset( &var_saHpiOEMEventTimestamp, 0x00, sizeof(var_saHpiOEMEventTimestamp) );
       var_saHpiOEMEventTimestamp.type = ASN_OCTET_STR; /* type hint for parse_oid_indexes */
       var_saHpiOEMEventTimestamp.next_variable = NULL;
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
              ...
              /** skipping external index saHpiEventHistorical */
                ...
                if(var_saHpiOEMEventTimestamp.val_len > sizeof(ctx->saHpiOEMEventTimestamp))
                   err = -1;
                else
                    memcpy( ctx->saHpiOEMEventTimestamp, var_saHpiOEMEventTimestamp.val.string, var_saHpiOEMEventTimestamp.val_len );
                ctx->saHpiOEMEventTimestamp_len = var_saHpiOEMEventTimestamp.val_len;
		...
		if(!err)
			err = saHpiOEMEventTimestamp_check_index(&var_saHpiOEMEventTimestamp);
          ...
          */
            ...
            * TODO: check index for valid values. For EXAMPLE:
            *
              * if ( XXX_check_value( var_saHpiOEMEventTimestamp.val.string, XXX ) ) {
          *    err = -1;
          * }
          */
    }
...
void saHpiOEMEventTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIOEMEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiOEMEventDelete));
        break;
...
void saHpiOEMEventTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIOEMEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiOEMEventDelete = *var->val.integer;
        break;
...
initialize_table_saHpiOEMEventTable(void)
{
    ...
    if(my_handler) {
        snmp_log(LOG_ERR, "initialize_table_saHpiOEMEventTable_handler called again\n");
        return;
    }
    ...
    if (!my_handler || !table_info) {
        snmp_log(LOG_ERR, "malloc failed in "
                 "initialize_table_saHpiOEMEventTable_handler\n");
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIOEMEVENTTIMESTAMP:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         ...
                         context->saHpiOEMEventTimestamp_len );
        break;
        ...
        case COLUMN_SAHPIOEMEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiOEMEventDelete,
                         sizeof(context->saHpiOEMEventDelete) );
        break;

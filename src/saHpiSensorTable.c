...
saHpiSensorTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiSensorTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
saHpiSensorTable_get( const char *name, int len )
{
    saHpiSensorTable_context tmp;
     ...
     */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorTable_get not implemented!\n" );
    return NULL;
#endif
...
init_saHpiSensorTable(void)
{
     ...
     *
     * saHpiSensorTable_context * new_row = create_row(index);
                         ...
                         saHpiSensorTable_context * src)
{
    ...
    dst->saHpiSensorEnable = src->saHpiSensorEnable;

    dst->saHpiSensorEventEnable = src->saHpiSensorEventEnable;

    dst->saHpiSensorEventCtrl = src->saHpiSensorEventCtrl;

    memcpy( dst->saHpiSensorSupportedStates, src->saHpiSensorSupportedStates, src->saHpiSensorSupportedStates_len );
    dst->saHpiSensorSupportedStates_len = src->saHpiSensorSupportedStates_len;

    memcpy( dst->saHpiSensorAssertEventMask, src->saHpiSensorAssertEventMask, src->saHpiSensorAssertEventMask_len );
    dst->saHpiSensorAssertEventMask_len = src->saHpiSensorAssertEventMask_len;

    memcpy( dst->saHpiSensorDeassertEventMask, src->saHpiSensorDeassertEventMask, src->saHpiSensorDeassertEventMask_len );
    dst->saHpiSensorDeassertEventMask_len = src->saHpiSensorDeassertEventMask_len;

    dst->saHpiSensorCategory = src->saHpiSensorCategory;

    dst->saHpiSensorEventsCategoryControl = src->saHpiSensorEventsCategoryControl;

    memcpy( dst->saHpiSensorEventsSupported, src->saHpiSensorEventsSupported, src->saHpiSensorEventsSupported_len );
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorTable_extract_index index list not implemented!\n" );
    return 0;
#else
...
saHpiSensorTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSensorEnable = 0;
     ctx->saHpiSensorEventEnable = 0;
     ctx->saHpiSensorEventCtrl = 0;
     ctx->saHpiSensorSupportedStates = 0;
     ctx->saHpiSensorAssertEventMask = 0;
     ctx->saHpiSensorDeassertEventMask = 0;
    */
...
void saHpiSensorTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORENABLE:
            /** TruthValue = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorEnable));
        break;

        case COLUMN_SAHPISENSOREVENTENABLE:
            /** TruthValue = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorEventEnable));
        break;

        case COLUMN_SAHPISENSOREVENTCTRL:
            /** INTEGER = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorEventCtrl));
        break;

        case COLUMN_SAHPISENSORSUPPORTEDSTATES:
            /** SaHpiEventState = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorSupportedStates));
        break;

        case COLUMN_SAHPISENSORASSERTEVENTMASK:
            /** SaHpiEventState = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorAssertEventMask));
        break;

        case COLUMN_SAHPISENSORDEASSERTEVENTMASK:
            /** SaHpiEventState = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorDeassertEventMask));
        break;
...
void saHpiSensorTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORENABLE:
            /** TruthValue = ASN_INTEGER */
            row_ctx->saHpiSensorEnable = *var->val.integer;
        break;

        case COLUMN_SAHPISENSOREVENTENABLE:
            /** TruthValue = ASN_INTEGER */
            row_ctx->saHpiSensorEventEnable = *var->val.integer;
        break;

        case COLUMN_SAHPISENSOREVENTCTRL:
            /** INTEGER = ASN_INTEGER */
            row_ctx->saHpiSensorEventCtrl = *var->val.integer;
        break;

        case COLUMN_SAHPISENSORSUPPORTEDSTATES:
            /** SaHpiEventState = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorSupportedStates,var->val.string,var->val_len);
            row_ctx->saHpiSensorSupportedStates_len = var->val_len;
        break;

        case COLUMN_SAHPISENSORASSERTEVENTMASK:
            /** SaHpiEventState = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorAssertEventMask,var->val.string,var->val_len);
            row_ctx->saHpiSensorAssertEventMask_len = var->val_len;
        break;

        case COLUMN_SAHPISENSORDEASSERTEVENTMASK:
            /** SaHpiEventState = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorDeassertEventMask,var->val.string,var->val_len);
            row_ctx->saHpiSensorDeassertEventMask_len = var->val_len;
        break;
     ...
     * requirements here.
     */
#ifndef saHpiSensorTable_CAN_MODIFY_ACTIVE_ROW
...
#endif /** saHpiSensorTable_SET_HANDLING */
            ...
            netsnmp_table_request_info *table_info )
{
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPISENSORENABLE:
            /** TruthValue = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiSensorEnable,
                         sizeof(context->saHpiSensorEnable) );
        break;
    
        case COLUMN_SAHPISENSOREVENTENABLE:
            /** TruthValue = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiSensorEventEnable,
                         sizeof(context->saHpiSensorEventEnable) );
        break;
        ...
        case COLUMN_SAHPISENSORSUPPORTEDSTATES:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         (char*)&context->saHpiSensorSupportedStates,
                         context->saHpiSensorSupportedStates_len );
        break;
    
        case COLUMN_SAHPISENSORASSERTEVENTMASK:
            /** SaHpiEventState = ASN_OCTET_STR */
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         (char*)&context->saHpiSensorAssertEventMask,
                         context->saHpiSensorAssertEventMask_len );
        break;
    
        case COLUMN_SAHPISENSORDEASSERTEVENTMASK:
            /** SaHpiEventState = ASN_OCTET_STR */
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         (char*)&context->saHpiSensorDeassertEventMask,
                         context->saHpiSensorDeassertEventMask_len );
        break;
        ...
        case COLUMN_SAHPISENSOREVENTSCATEGORYCONTROL:
            /** INTEGER = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiSensorEventsCategoryControl,
                         sizeof(context->saHpiSensorEventsCategoryControl) );
        break;
    
        case COLUMN_SAHPISENSOREVENTSSUPPORTED:
            /** SaHpiEventState = ASN_OCTET_STR */
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         (char*)&context->saHpiSensorEventsSupported,

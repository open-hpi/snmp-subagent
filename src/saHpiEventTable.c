                         ...
                         saHpiEventTable_context * src)
{
    ...
    memcpy( src->saHpiEvent, dst->saHpiEvent, src->saHpiEvent_len );
    dst->saHpiEvent_len = src->saHpiEvent_len;

    dst->saHpiEventSeverity = src->saHpiEventSeverity;

    dst->saHpiEventHistorical = src->saHpiEventHistorical;

    dst->saHpiEventQueueStatus = src->saHpiEventQueueStatus;

    memcpy( dst->saHpiEventSaHpiTime, src->saHpiEventSaHpiTime, src->saHpiEventSaHpiTime_len );
...
saHpiEventTable_extract_index( saHpiEventTable_context * ctx, netsnmp_index * hdr )
{
    ...
    netsnmp_variable_list var_saHpiEvent;
    netsnmp_variable_list var_saHpiEventSeverity;
    netsnmp_variable_list var_saHpiEventHistorical;
    netsnmp_variable_list var_saHpiEventQueueStatus;
    netsnmp_variable_list var_saHpiEventSaHpiTime;
    int err;
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
              ...
              /** skipping external index saHpiResourceId */
                ...
                memcpy( ctx->saHpiEvent, var_saHpiEvent.val.string, var_saHpiEvent.val_len );
                ctx->saHpiEvent_len = var_saHpiEvent.val_len;
   
                ctx->saHpiEventSeverity = *var_saHpiEventSeverity.val.integer;
   
                ctx->saHpiEventHistorical = *var_saHpiEventHistorical.val.integer;
   
                ctx->saHpiEventQueueStatus = *var_saHpiEventQueueStatus.val.integer;
   
                if(var_saHpiEventSaHpiTime.val_len > sizeof(ctx->saHpiEventSaHpiTime))
                   err = -1;
                else
...
initialize_table_saHpiEventTable(void)
{
     ...
     */
        ...
        netsnmp_table_helper_add_index(table_info, ASN_INTEGER);
        /** index: saHpiEventQueueStatus */
        netsnmp_table_helper_add_index(table_info, ASN_UNSIGNED);
        /** index: saHpiEventSaHpiTime */
            ...
            netsnmp_table_request_info *table_info )
{
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIEVENT:
            /** RowPointer = ASN_OBJECT_ID */
            snmp_set_var_typed_value(var, ASN_OBJECT_ID,
                         (char*)&context->saHpiEvent,
                         context->saHpiEvent_len );
        break;
        ...
        case COLUMN_SAHPIEVENTHISTORICAL:
            /** TruthValue = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiEventHistorical,
                         sizeof(context->saHpiEventHistorical) );
        break;
    
        case COLUMN_SAHPIEVENTQUEUESTATUS:
            /** UNSIGNED32 = ASN_UNSIGNED */
            snmp_set_var_typed_value(var, ASN_UNSIGNED,
                         (char*)&context->saHpiEventQueueStatus,
                         sizeof(context->saHpiEventQueueStatus) );
        break;

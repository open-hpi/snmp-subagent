                         ...
                         saHpiWatchdogEventTable_context * src)
{
    ...
    memcpy( dst->saHpiWatchdogEventTimestamp, src->saHpiWatchdogEventTimestamp, src->saHpiWatchdogEventTimestamp_len );
    ...
    dst->saHpiWatchdogEventDelete = src->saHpiWatchdogEventDelete;
...
saHpiWatchdogEventTable_extract_index( saHpiWatchdogEventTable_context * ctx, netsnmp_index * hdr )
{
    ...
    netsnmp_variable_list var_saHpiWatchdogEventTimestamp;
    int err;
     ...
     */
       ...
       var_saHpiEventHistorical.next_variable = &var_saHpiWatchdogEventTimestamp;

       memset( &var_saHpiWatchdogEventTimestamp, 0x00, sizeof(var_saHpiWatchdogEventTimestamp) );
       var_saHpiWatchdogEventTimestamp.type = ASN_OCTET_STR; /* type hint for parse_oid_indexes */
       var_saHpiWatchdogEventTimestamp.next_variable = NULL;
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
              ...
              /** skipping external index saHpiEventHistorical */
                ...
                if(var_saHpiWatchdogEventTimestamp.val_len > sizeof(ctx->saHpiWatchdogEventTimestamp))
                   err = -1;
                else
                    memcpy( ctx->saHpiWatchdogEventTimestamp, var_saHpiWatchdogEventTimestamp.val.string, var_saHpiWatchdogEventTimestamp.val_len );
                ctx->saHpiWatchdogEventTimestamp_len = var_saHpiWatchdogEventTimestamp.val_len;
		...
		if(!err)
			err = saHpiTimeString_check_index(&var_saHpiWatchdogEventTimestamp);
    }
...
saHpiWatchdogEventTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiWatchdogEventDelete = 0;
    */
...
void saHpiWatchdogEventTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIWATCHDOGEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiWatchdogEventDelete));
        break;
...
void saHpiWatchdogEventTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIWATCHDOGEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiWatchdogEventDelete = *var->val.integer;
        break;
...
initialize_table_saHpiWatchdogEventTable(void)
{
     ...
     */
        ...
        netsnmp_table_helper_add_index(table_info, ASN_INTEGER);
        /** index: saHpiWatchdogEventTimestamp */
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIWATCHDOGEVENTTIMESTAMP:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         ...
                         context->saHpiWatchdogEventTimestamp_len );
        break;
        ...
        case COLUMN_SAHPIWATCHDOGEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiWatchdogEventDelete,
                         sizeof(context->saHpiWatchdogEventDelete) );
        break;

...
static state_category_string state_string[] = {
    {SAHPI_EC_UNSPECIFIED, SAHPI_ES_UNSPECIFIED, "SAHPI_ES_UNSPECIFIED"},
    {SAHPI_EC_THRESHOLD, SAHPI_ES_UNSPECIFIED, "SAHPI_ES_UNSPECIFIED"},
    {SAHPI_EC_THRESHOLD, SAHPI_ES_LOWER_MINOR, "SAHPI_ES_LOWER_MINOR"},
    {SAHPI_EC_THRESHOLD, SAHPI_ES_LOWER_MAJOR, "SAHPI_ES_LOWER_MAJOR"},
    {SAHPI_EC_THRESHOLD, SAHPI_ES_LOWER_CRIT, "SAHPI_ES_LOWER_CRIT"},
    {SAHPI_EC_THRESHOLD, SAHPI_ES_UPPER_MINOR, "SAHPI_ES_UPPER_MINOR"},
    {SAHPI_EC_THRESHOLD, SAHPI_ES_UPPER_MAJOR, "SAHPI_ES_UPPER_MAJOR"},
    {SAHPI_EC_THRESHOLD, SAHPI_ES_UPPER_CRIT, "SAHPI_ES_UPPER_CRIT"},
    {SAHPI_EC_USAGE, SAHPI_ES_IDLE, "SAHPI_ES_IDLE"},
    {SAHPI_EC_USAGE, SAHPI_ES_ACTIVE, "SAHPI_ES_ACTIVE"},
    {SAHPI_EC_USAGE, SAHPI_ES_BUSY, "SAHPI_ES_BUSY"},
    {SAHPI_EC_STATE, SAHPI_ES_STATE_DEASSERTED, "SAHPI_ES_STATE_DEASSERTED"},
    {SAHPI_EC_STATE, SAHPI_ES_STATE_ASSERTED, "SAHPI_ES_STATE_ASSERTED"},
    {SAHPI_EC_PRED_FAIL, SAHPI_ES_PRED_FAILURE_DEASSERT, "SAHPI_ES_PRED_FAILURE_DEASSERT"},
    {SAHPI_EC_PRED_FAIL, SAHPI_ES_PRED_FAILURE_ASSERT, "SAHPI_ES_PRED_FAILURE_ASSERT"},
    {SAHPI_EC_LIMIT, SAHPI_ES_LIMIT_NOT_EXCEEDED, "SAHPI_ES_LIMIT_NOT_EXCEEDED"},
    {SAHPI_EC_LIMIT, SAHPI_ES_LIMIT_EXCEEDED, "SAHPI_ES_LIMIT_EXCEEDED"},
    {SAHPI_EC_PERFORMANCE, SAHPI_ES_PERFORMANCE_MET, "SAHPI_ES_PERFORMANCE_MET"},
    {SAHPI_EC_PERFORMANCE, SAHPI_ES_PERFORMANCE_LAGS, "SAHPI_ES_PERFORMANCE_LAGS"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_OK, "SAHPI_ES_OK"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_MINOR_FROM_OK, "SAHPI_ES_MINOR_FROM_OK"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_MAJOR_FROM_LESS, "SAHPI_ES_MAJOR_FROM_LESS"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_CRITICAL_FROM_LESS, "SAHPI_ES_CRITICAL_FROM_LESS"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_MINOR_FROM_MORE, "SAHPI_ES_MINOR_FROM_MORE"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_MAJOR_FROM_CRITICAL, "SAHPI_ES_MAJOR_FROM_CRITICAL"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_CRITICAL, "SAHPI_ES_CRITICAL"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_MONITOR, "SAHPI_ES_MONITOR"},
    {SAHPI_EC_SEVERITY, SAHPI_ES_INFORMATIONAL, "SAHPI_ES_INFORMATIONAL"},
    {SAHPI_EC_PRESENCE, SAHPI_ES_ABSENT, "SAHPI_ES_ABSENT"},
    {SAHPI_EC_PRESENCE, SAHPI_ES_PRESENT, "SAHPI_ES_PRESENT"},
    {SAHPI_EC_ENABLE, SAHPI_ES_DISABLED, "SAHPI_ES_DISABLED"},
    {SAHPI_EC_ENABLE, SAHPI_ES_ENABLED, "SAHPI_ES_ENABLED"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_RUNNING, "SAHPI_ES_RUNNING"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_TEST, "SAHPI_ES_TEST"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_POWER_OFF, "SAHPI_ES_POWER_OFF"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_ON_LINE, "SAHPI_ES_ON_LINE"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_OFF_LINE, "SAHPI_ES_OFF_LINE"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_OFF_DUTY, "SAHPI_ES_OFF_DUTY"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_DEGRADED, "SAHPI_ES_DEGRADED"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_POWER_SAVE, "SAHPI_ES_POWER_SAVE"},
    {SAHPI_EC_AVAILABILITY, SAHPI_ES_INSTALL_ERROR, "SAHPI_ES_INSTALL_ERROR"},
    {SAHPI_EC_REDUNDANCY, SAHPI_ES_FULLY_REDUNDANT, "SAHPI_ES_FULLY_REDUNDANT"},
    {SAHPI_EC_REDUNDANCY, SAHPI_ES_REDUNDANCY_LOST, "SAHPI_ES_REDUNDANCY_LOST"},
    {SAHPI_EC_REDUNDANCY, SAHPI_ES_REDUNDANCY_DEGRADED, "SAHPI_ES_REDUNDANCY_DEGRADED"},
    {SAHPI_EC_REDUNDANCY, SAHPI_ES_REDUNDANCY_LOST_SUFFICIENT_RESOURCES, "SAHPI_ES_REDUNDANCY_LOST_SUFFICIENT_RESOURCES"},
    {SAHPI_EC_REDUNDANCY, SAHPI_ES_NON_REDUNDANT_SUFFICIENT_RESOURCES, "SAHPI_ES_NON_REDUNDANT_SUFFICIENT_RESOURCES"},

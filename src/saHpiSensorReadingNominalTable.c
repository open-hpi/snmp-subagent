...
saHpiSensorReadingNominalTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiSensorReadingNominalTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
saHpiSensorReadingNominalTable_get( const char *name, int len )
{
    saHpiSensorReadingNominalTable_context tmp;
     ...
     */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorReadingNominalTable_get not implemented!\n" );
    return NULL;
#endif
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorReadingNominalTable_extract_index index list not implemented!\n" );
    return 0;
#else
...
saHpiSensorReadingNominalTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSensorReadingNominalType = 0;
     ctx->saHpiSensorReadingNominalValue = 0;
    */
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGNOMINALTYPE:
            ...
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorReadingNominalType));
        break;

        case COLUMN_SAHPISENSORREADINGNOMINALVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorReadingNominalValue));
        break;
...
void saHpiSensorReadingNominalTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGNOMINALTYPE:
            /** SaHpiSensorReadingType = ASN_INTEGER */
            row_ctx->saHpiSensorReadingNominalType = *var->val.integer;
        break;

        case COLUMN_SAHPISENSORREADINGNOMINALVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorReadingNominalValue,var->val.string,var->val_len);
            row_ctx->saHpiSensorReadingNominalValue_len = var->val_len;
        break;
     ...
     * requirements here.
     */
#ifndef saHpiSensorReadingNominalTable_CAN_MODIFY_ACTIVE_ROW
...
#endif /** saHpiSensorReadingNominalTable_SET_HANDLING */

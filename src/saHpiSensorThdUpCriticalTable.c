...
oid saHpiSensorThdUpCriticalTable_oid[] =
  { saHpiSensorThdUpCriticalTable_TABLE_OID };
size_t saHpiSensorThdUpCriticalTable_oid_len =
OID_LENGTH (saHpiSensorThdUpCriticalTable_oid);

static int
modify_saHpiSensorThdUpCriticalTable_row (SaHpiDomainIdT domain_id,
			   ...
			   SaHpiSensorNumT sensor_num)
{
  ...
  DEBUGMSGTL ((AGENT, "delete_ThdUpCritical_row (%d, %d, %d). Entry.\n",
  ...
  if (ctx)
    {
      ...
      saHpiSensorThdUpCriticalTable_delete_row (ctx);
      rc = AGENT_ERR_NOERROR;
    }
  DEBUGMSGTL ((AGENT, "delete_ThdUpCritical_row. Exit (rc: %d).\n", rc));
  return rc;
}


int
populate_ThdUpCritical (SaHpiDomainIdT domain_id,
			 SaHpiResourceIdT resource_id,
			 ...
			 SaHpiSensorReadingT * reading)
{
  ...
  DEBUGMSGT ((AGENT, "\t--- populate_ThdUpCritical, Entry,\n"));
  ...
  if (reading && threshold_def)
      ...
      if (!ctx)
	{
	   ...
	   */
	  ctx =
	    saHpiSensorThdUpCriticalTable_create_row (&sensor_thd_index);
	}
      if (!ctx)
	{
	  snmp_log (LOG_ERR,
		    "Not enough memory for a sensor ThdUpCritical row!");
	  return AGENT_ERR_INTERNAL_ERROR;
	}

      if (modify_saHpiSensorThdUpCriticalTable_row (domain_id,
						     resource_id,
						     sensor_id,
						     threshold_def,
						     reading,
  ...
  DEBUGMSGT ((AGENT, "\t--- populate_ThdUpCritical, Exit (rc: %d),\n", rc));
					   ...
					   * ctx)
{
  ...
  DEBUGMSGTL ((AGENT, "Modify saHpiSensorThdUpCriticalTable_ctx: Entry.\n"));
  ...
  if (ctx)
      ...
      if (ctx->hash != 0)
	{
	  ...
	  if ((ctx->domain_id == domain_id) &&
	      ...
	      (ctx->sensor_id == sensor_num))
	    {
	      ...
	      DEBUGMSGTL ((AGENT,
			   "Updating ThdUpCriticalTable row [%d, %d, %d]\n",
			   domain_id, resource_id, sensor_num));
	    }
	}
	...
	hash = 1;		/* Need this - we consider hash
      ...
      build_reading_strings (reading,
			     0,
			     &ctx->saHpiSensorThdUpCriticalValuesPresent,
			     &ctx->saHpiSensorThdUpCriticalRaw,
			     ctx->saHpiSensorThdUpCriticalInterpreted,
			     &ctx->saHpiSensorThdUpCriticalInterpreted_len,
			     SENSOR_THD_INTER_MAX,
			     NULL, NULL, NULL, 0);

      ctx->saHpiSensorThdUpCriticalIsReadable = 
	((threshold_def->ReadThold & SAHPI_STM_UP_CRIT) == SAHPI_STM_UP_CRIT) ?
	MIB_TRUE : MIB_FALSE;
      
      ctx->saHpiSensorThdUpCriticalIsWritable = 
	((threshold_def->WriteThold & SAHPI_STM_UP_CRIT) == SAHPI_STM_UP_CRIT) ?
	MIB_TRUE : MIB_FALSE;
  ctx->saHpiSensorThdUpCriticalIsFixed = 
	((threshold_def->FixedThold & SAHPI_STM_UP_CRIT) == SAHPI_STM_UP_CRIT) ?
	MIB_TRUE : MIB_FALSE;

      /* END */
      DEBUGMSGTL ((AGENT, "Modify saHpiSensorThdUpCriticalTable_ctx: Exit"));
  ...
  DEBUGMSGTL ((AGENT,
	       "Modify saHpiSensorThdUpCriticalTable_ctx: Exit (NULL DATA)"));
...
int set_ThdUpCritical (saHpiSensorThdUpCriticalTable_context *ctx) {
  ...
  DEBUGMSGTL ((AGENT, "set_ThdUpCritical: Entry.\n"));
  if (ctx)
    {
	...
	/* Update the correct entry.	 */
      ...
      if (thd.UpCritical.ValuesPresent & SAHPI_SRF_INTERPRETED) {
	thd.UpCritical.Interpreted.Type = SAHPI_SENSOR_INTERPRETED_TYPE_BUFFER;
	memcpy(&thd.UpCritical.Interpreted.Value.SensorBuffer,
		&ctx->saHpiSensorThdUpCriticalInterpreted,
		ctx->saHpiSensorThdUpCriticalInterpreted_len);
	       
      }
      if (thd.UpCritical.ValuesPresent & SAHPI_SRF_RAW) {
	thd.UpCritical.Raw = ctx->saHpiSensorThdUpCriticalRaw;
      }
      ...
      if (rc != SA_OK)
	{
      ...
      build_reading_strings (&thd.UpCritical,
			     0,
			     &ctx->saHpiSensorThdUpCriticalValuesPresent,
			     &ctx->saHpiSensorThdUpCriticalRaw,
			     ctx->saHpiSensorThdUpCriticalInterpreted,
      ...
      DEBUGMSGTL ((AGENT, "set_ThdUpCritical: Exit.\n"));
 ...
 */
static int
  saHpiSensorThdUpCriticalTable_row_copy
  (saHpiSensorThdUpCriticalTable_context * dst,
   saHpiSensorThdUpCriticalTable_context * src)
{
   ...
   */
   dst->saHpiSensorThdUpCriticalIsReadable =
        src->saHpiSensorThdUpCriticalIsReadable;

    dst->saHpiSensorThdUpCriticalIsWritable =
        src->saHpiSensorThdUpCriticalIsWritable;

    dst->saHpiSensorThdUpCriticalIsFixed =
        src->saHpiSensorThdUpCriticalIsFixed;

    dst->saHpiSensorThdUpCriticalValuesPresent =
        src->saHpiSensorThdUpCriticalValuesPresent;

    dst->saHpiSensorThdUpCriticalRaw = src->saHpiSensorThdUpCriticalRaw;

    memcpy(dst->saHpiSensorThdUpCriticalInterpreted,
           src->saHpiSensorThdUpCriticalInterpreted,
           src->saHpiSensorThdUpCriticalInterpreted_len);
    dst->saHpiSensorThdUpCriticalInterpreted_len =
        src->saHpiSensorThdUpCriticalInterpreted_len;
...
saHpiSensorThdUpCriticalTable_create_row (netsnmp_index * hdr)
{
  ...
  ctx->saHpiSensorThdUpCriticalIsReadable = MIB_FALSE;
  ctx->saHpiSensorThdUpCriticalIsWritable= MIB_FALSE;
  ctx->saHpiSensorThdUpCriticalIsFixed = MIB_FALSE;
  ctx->saHpiSensorThdUpCriticalValuesPresent= 0;
  return ctx;
}
 ...
 */
netsnmp_index *saHpiSensorThdUpCriticalTable_delete_row
  (saHpiSensorThdUpCriticalTable_context * ctx)
{
  /*
 ...
 */
void
saHpiSensorThdUpCriticalTable_set_reserve1 (netsnmp_request_group * rg)
{
  saHpiSensorThdUpCriticalTable_context *row_ctx =
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdUpCriticalTable_set_reserve1. Entry.\n"));
	...
	case COLUMN_SAHPISENSORTHDUPCRITICALISFIXED:
	case COLUMN_SAHPISENSORTHDUPCRITICALVALUESPRESENT:
	  rc = SNMP_ERR_NOTWRITABLE;
	  break;

        case COLUMN_SAHPISENSORTHDUPCRITICALRAW:
            /** UNSIGNED32 = ASN_UNSIGNED */
            rc = netsnmp_check_vb_type_and_size(var, ASN_UNSIGNED,
                                                sizeof(row_ctx->
                                                       saHpiSensorThdUpCriticalRaw));
            break;

        case COLUMN_SAHPISENSORTHDUPCRITICALINTERPRETED:
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdUpCriticalTable_set_reserve1. Exit. (rc:%d) \n",rc));
}

void
saHpiSensorThdUpCriticalTable_set_reserve2 (netsnmp_request_group * rg)
{
 saHpiSensorThdUpCriticalTable_context *row_ctx =
        (saHpiSensorThdUpCriticalTable_context *) rg->existing_row;
    netsnmp_request_group_item *current;
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdUpCriticalTable_set_reserve2. Entry.\n"));
    for (current = rg->list; current; current = current->next) {
        ...
        case COLUMN_SAHPISENSORTHDUPCRITICALRAW:
            /** UNSIGNED32 = ASN_UNSIGNED */
	  if (row_ctx->saHpiSensorThdUpCriticalIsWritable == MIB_FALSE)
	  {
	    rc = SNMP_ERR_NOACCESS;
	  }
	  if (row_ctx->saHpiSensorThdUpCriticalIsFixed == MIB_TRUE)
	    {
	    rc = SNMP_ERR_NOACCESS;
	    }
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdUpCriticalTable_set_reserve2. Exit (rc:%d).\n",rc));
}
 ...
 */
void
saHpiSensorThdUpCriticalTable_set_action (netsnmp_request_group * rg)
{
 netsnmp_variable_list *var;
    saHpiSensorThdUpCriticalTable_context *row_ctx =
        (saHpiSensorThdUpCriticalTable_context *) rg->existing_row;
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdUpCriticalTable_set_action. Entry\n")); 
    for (current = rg->list; current; current = current->next) {
        ...
        case COLUMN_SAHPISENSORTHDUPCRITICALRAW:
            /** UNSIGNED32 = ASN_UNSIGNED */
            row_ctx->saHpiSensorThdUpCriticalRaw = *var->val.integer;
	    if (set_ThdUpCritical(row_ctx) != AGENT_ERR_NOERROR)
	      rc = SNMP_ERR_GENERR;
            break;

        case COLUMN_SAHPISENSORTHDUPCRITICALINTERPRETED:
            /** OCTETSTR = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorThdUpCriticalInterpreted,
                   var->val.string, var->val_len);
            row_ctx->saHpiSensorThdUpCriticalInterpreted_len =
                var->val_len;
	    if (set_ThdUpCritical(row_ctx) != AGENT_ERR_NOERROR)
	      rc = SNMP_ERR_GENERR;
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdUpCriticalTable_set_action. Exit (rc: %d)\n",rc)); 
}
 ...
 */
void
saHpiSensorThdUpCriticalTable_set_commit (netsnmp_request_group * rg)
{
 ...
 */
void
saHpiSensorThdUpCriticalTable_set_free (netsnmp_request_group * rg)
{
 ...
 */
void
saHpiSensorThdUpCriticalTable_set_undo (netsnmp_request_group * rg)
{
...
initialize_table_saHpiSensorThdUpCriticalTable (void)
{
  ...
  if (my_handler)
    {
      snmp_log (LOG_ERR,
		"initialize_table_saHpiSensorThdUpCriticalTable_handler called again\n");
      return;
    }
  ...
  my_handler =
    ...
    ("saHpiSensorThdUpCriticalTable",
     ...
     saHpiSensorThdUpCriticalTable_oid_len, HANDLER_CAN_RWRITE);
  ...
  cb.container =
    netsnmp_container_find ("saHpiSensorThdUpCriticalTable_primary:"
			    "saHpiSensorThdUpCriticalTable:"
			    "table_container");
  ...
  cb.duplicate_row =
    (UserRowMethod *) saHpiSensorThdUpCriticalTable_duplicate_row;
  cb.delete_row = (UserRowMethod *) saHpiSensorThdUpCriticalTable_delete_row;
  cb.row_copy =
    (Netsnmp_User_Row_Operation *) saHpiSensorThdUpCriticalTable_row_copy;

  cb.can_delete =
    (Netsnmp_User_Row_Action *) saHpiSensorThdUpCriticalTable_can_delete;
 ...
 */
int
saHpiSensorThdUpCriticalTable_get_value (netsnmp_request_info * request,
					  netsnmp_index * item,
					  netsnmp_table_request_info
					  * table_info)
{
  netsnmp_variable_list *var = request->requestvb;
  saHpiSensorThdUpCriticalTable_context *context =
    (saHpiSensorThdUpCriticalTable_context *) item;
  ...
  switch (table_info->colnum)
    ...
    case COLUMN_SAHPISENSORTHDUPCRITICALISFIXED:
        ...
        snmp_set_var_typed_value(var, ASN_INTEGER,
                                 (char *) &context->
                                 saHpiSensorThdUpCriticalIsFixed,
                                 sizeof(context->
                                        saHpiSensorThdUpCriticalIsFixed));
        break;
    ...
    case COLUMN_SAHPISENSORTHDUPCRITICALVALUESPRESENT:
        ...
        snmp_set_var_typed_value(var, ASN_INTEGER,
                                 (char *) &context->
                                 saHpiSensorThdUpCriticalValuesPresent,
                                 sizeof(context->
                                        saHpiSensorThdUpCriticalValuesPresent));
        break;
    ...
    case COLUMN_SAHPISENSORTHDUPCRITICALRAW:
            /** UNSIGNED32 = ASN_UNSIGNED */
	if (context->saHpiSensorThdUpCriticalIsReadable == MIB_TRUE)
	...
	if (context->saHpiSensorThdUpCriticalIsReadable == MIB_TRUE)
        snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                 (char *) &context->
                                 saHpiSensorThdUpCriticalInterpreted,
                                 context->
                                 saHpiSensorThdUpCriticalInterpreted_len);
        break;

...
saHpiHotSwapEventTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiHotSwapEventTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
                         ...
                         saHpiHotSwapEventTable_context * src)
{
    ...
    memcpy( dst->saHpiHotSwapEventTimestamp, src->saHpiHotSwapEventTimestamp, src->saHpiHotSwapEventTimestamp_len );
    ...
    dst->saHpiHotSwapEventDelete = src->saHpiHotSwapEventDelete;
...
saHpiHotSwapEventTable_extract_index( saHpiHotSwapEventTable_context * ctx, netsnmp_index * hdr )
{
    ...
    netsnmp_variable_list var_saHpiHotSwapEventTimestamp;
    int err;
     ...
     */
       ...
       var_saHpiEventHistorical.next_variable = &var_saHpiHotSwapEventTimestamp;

       memset( &var_saHpiHotSwapEventTimestamp, 0x00, sizeof(var_saHpiHotSwapEventTimestamp) );
       var_saHpiHotSwapEventTimestamp.type = ASN_OCTET_STR; /* type hint for parse_oid_indexes */
       var_saHpiHotSwapEventTimestamp.next_variable = NULL;
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
              ...
              /** skipping external index saHpiEventHistorical */
                ...
                if(var_saHpiHotSwapEventTimestamp.val_len > sizeof(ctx->saHpiHotSwapEventTimestamp))
                   err = -1;
                else
                    memcpy( ctx->saHpiHotSwapEventTimestamp, var_saHpiHotSwapEventTimestamp.val.string, var_saHpiHotSwapEventTimestamp.val_len );
                ctx->saHpiHotSwapEventTimestamp_len = var_saHpiHotSwapEventTimestamp.val_len;
		...
		if(!err)
			err = saHpiHotSwapEventTimestamp_check_index(&var_saHpiHotSwapEventTimestamp);
...
void saHpiHotSwapEventTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIHOTSWAPEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiHotSwapEventDelete));
        break;
...
void saHpiHotSwapEventTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIHOTSWAPEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiHotSwapEventDelete = *var->val.integer;
        break;
     ...
     */
#if 0 /* TODO DMJ */
#ifndef saHpiHotSwapEventTable_CAN_MODIFY_ACTIVE_ROW
...
initialize_table_saHpiHotSwapEventTable(void)
{
     ...
     */
        ...
        netsnmp_table_helper_add_index(table_info, ASN_INTEGER);
        /** index: saHpiHotSwapEventTimestamp */
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIHOTSWAPEVENTTIMESTAMP:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         ...
                         context->saHpiHotSwapEventTimestamp_len );
        break;
        ...
        case COLUMN_SAHPIHOTSWAPEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiHotSwapEventDelete,
                         sizeof(context->saHpiHotSwapEventDelete) );
        break;

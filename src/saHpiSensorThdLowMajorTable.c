...
saHpiSensorThdLowMajorTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiSensorThdLowMajorTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
saHpiSensorThdLowMajorTable_get( const char *name, int len )
{
    saHpiSensorThdLowMajorTable_context tmp;
     ...
     */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorThdLowMajorTable_get not implemented!\n" );
    return NULL;
#endif
...
init_saHpiSensorThdLowMajorTable(void)
{
     ...
     *
     * saHpiSensorThdLowMajorTable_context * new_row = create_row(index);
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiSensorThdLowMajorTable_extract_index index list not implemented!\n" );
    return 0;
#else
...
saHpiSensorThdLowMajorTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSensorThdLowMajorType = 0;
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORTHDLOWMAJORTYPE:
            ...
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorThdLowMajorType));
        break;

        case COLUMN_SAHPISENSORTHDLOWMAJORVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorThdLowMajorValue));
        break;
...
void saHpiSensorThdLowMajorTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORTHDLOWMAJORTYPE:
            /** SaHpiSensorReadingType = ASN_INTEGER */
            row_ctx->saHpiSensorThdLowMajorType = *var->val.integer;
        break;

        case COLUMN_SAHPISENSORTHDLOWMAJORVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorThdLowMajorValue,var->val.string,var->val_len);
     ...
     * requirements here.
     */
#ifndef saHpiSensorThdLowMajorTable_CAN_MODIFY_ACTIVE_ROW
...
#endif /** saHpiSensorThdLowMajorTable_SET_HANDLING */

...
saHpiCtrlOemTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiCtrlOemTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
saHpiCtrlOemTable_get( const char *name, int len )
{
    saHpiCtrlOemTable_context tmp;
     ...
     */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiCtrlOemTable_get not implemented!\n" );
    return NULL;
#endif
...
init_saHpiCtrlOemTable(void)
{
     ...
     *
     * saHpiCtrlOemTable_context * new_row = create_row(index);
...
saHpiCtrlOemTable_extract_index( saHpiCtrlOemTable_context * ctx, netsnmp_index * hdr )
{
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiCtrlOemTable_extract_index index list not implemented!\n" );
    return 0;
#else
    ...
    return 0;
#else
       var_saHpiCtrlOemEntryId.next_variable = &var_XX;
#endif
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
          ...
          */
            ...
            * TODO: check index for valid values. For EXAMPLE:
            *
              * if ( *var_saHpiCtrlOemEntryId.val.integer != XXX ) {
          *    err = -1;
          * }
          */
    }
...
void saHpiCtrlOemTable_set_action( netsnmp_request_group *rg )
{
     ...
     * requirements here.
     */
#ifndef saHpiCtrlOemTable_CAN_MODIFY_ACTIVE_ROW
...
#endif /** saHpiCtrlOemTable_SET_HANDLING */

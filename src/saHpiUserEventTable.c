...
saHpiUserEventTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiUserEventTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
init_saHpiUserEventTable(void)
{
     ...
     *
     * saHpiUserEventTable_context * new_row = create_row(index);
                         ...
                         saHpiUserEventTable_context * src)
{
    ...
    dst->saHpiUserEventDelete = src->saHpiUserEventDelete;
...
saHpiUserEventTable_extract_index( saHpiUserEventTable_context * ctx, netsnmp_index * hdr )
{
    ...
    netsnmp_variable_list var_saHpiUserEventTimestamp;
    int err;
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiUserEventTable_extract_index index list not implemented!\n" );
    return 0;
#else
    ...
    return 0;
       ...
       memset( &var_saHpiUserEventTimestamp, 0x00, sizeof(var_saHpiUserEventTimestamp) );
       var_saHpiUserEventTimestamp.type = ASN_OCTET_STR; /* type hint for parse_oid_indexes */
       /** TODO: link this index to the next, or NULL for the last one */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiUserEventTable_extract_index index list not implemented!\n" );
    return 0;
#else
       var_saHpiUserEventTimestamp.next_variable = &var_XX;
#endif
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
              ...
              /** skipping external index saHpiEventHistorical */
                ...
                if(var_saHpiUserEventTimestamp.val_len > sizeof(ctx->saHpiUserEventTimestamp))
                   err = -1;
                else
                    memcpy( ctx->saHpiUserEventTimestamp, var_saHpiUserEventTimestamp.val.string, var_saHpiUserEventTimestamp.val_len );
                ctx->saHpiUserEventTimestamp_len = var_saHpiUserEventTimestamp.val_len;
          ...
          */
            ...
            * TODO: check index for valid values. For EXAMPLE:
            *
              * if ( XXX_check_value( var_saHpiUserEventTimestamp.val.string, XXX ) ) {
          *    err = -1;
          * }
          */
    }
...
void saHpiUserEventTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIUSEREVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiUserEventDelete));
        break;
...
void saHpiUserEventTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIUSEREVENTTIMESTAMP:
            /** SaHpiTimeString = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiUserEventTimestamp,var->val.string,var->val_len);
            row_ctx->saHpiUserEventTimestamp_len = var->val_len;
        break;
        ...
        case COLUMN_SAHPIUSEREVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiUserEventDelete = *var->val.integer;
        break;
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIUSEREVENTTIMESTAMP:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         ...
                         context->saHpiUserEventTimestamp_len );
        break;
        ...
        case COLUMN_SAHPIUSEREVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiUserEventDelete,
                         sizeof(context->saHpiUserEventDelete) );
        break;

                            ...
                            saHpiWatchdogTable_context * src)
{
    ...
    dst->saHpiWatchdogPretimerInterrupt =
        src->saHpiWatchdogPretimerInterrupt;

    dst->saHpiWatchdogPreTimeoutInterval =
        src->saHpiWatchdogPreTimeoutInterval;

    dst->saHpiWatchdogTimerUseExpFlags =
        src->saHpiWatchdogTimerUseExpFlags;

    dst->saHpiWatchdogTimerInitialCount =
        src->saHpiWatchdogTimerInitialCount;

    dst->saHpiWatchdogTimerPresentCount =
        src->saHpiWatchdogTimerPresentCount;

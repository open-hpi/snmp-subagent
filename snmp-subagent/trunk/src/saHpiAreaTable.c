                         ...
                         saHpiAreaTable_context * src)
{
    ...
    dst->saHpiAreaDelete = src->saHpiAreaDelete;
...
void saHpiAreaTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIAREADELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiAreaDelete));
        break;
...
void saHpiAreaTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIAREADELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiAreaDelete = *var->val.integer;
        break;
            ...
            netsnmp_table_request_info *table_info )
{
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIAREADELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiAreaDelete,
                         sizeof(context->saHpiAreaDelete) );
        break;

...
saHpiRdrTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiRdrTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
saHpiRdrTable_get( const char *name, int len )
{
    saHpiRdrTable_context tmp;
     ...
     */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiRdrTable_get not implemented!\n" );
    return NULL;
#endif
...
saHpiRdrTable_extract_index( saHpiRdrTable_context * ctx, netsnmp_index * hdr )
{
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiRdrTable_extract_index index list not implemented!\n" );
    return 0;
#else
    ...
    return 0;
       ...
       var_saHpiRdrType.type = ASN_INTEGER; /* type hint for parse_oid_indexes */
       /** TODO: link this index to the next, or NULL for the last one */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiRdrTable_extract_index index list not implemented!\n" );
    return 0;
#else
       var_saHpiRdrType.next_variable = &var_XX;
#endif
...
void saHpiRdrTable_set_action( netsnmp_request_group *rg )
{
     ...
     * requirements here.
     */
#ifndef saHpiRdrTable_CAN_MODIFY_ACTIVE_ROW
...
#endif /** saHpiRdrTable_SET_HANDLING */

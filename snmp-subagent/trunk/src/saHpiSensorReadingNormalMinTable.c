...
saHpiSensorReadingNormalMinTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSensorReadingNormalMinType = 0;
     ctx->saHpiSensorReadingNormalMinValue = 0;
    */
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGNORMALMINTYPE:
            ...
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSensorReadingNormalMinType));
        break;

        case COLUMN_SAHPISENSORREADINGNORMALMINVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            rc = netsnmp_check_vb_type_and_size(var, ASN_OCTET_STR,
                                                sizeof(row_ctx->saHpiSensorReadingNormalMinValue));
        break;
...
void saHpiSensorReadingNormalMinTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISENSORREADINGNORMALMINTYPE:
            /** SaHpiSensorReadingType = ASN_INTEGER */
            row_ctx->saHpiSensorReadingNormalMinType = *var->val.integer;
        break;

        case COLUMN_SAHPISENSORREADINGNORMALMINVALUE:
            /** SaHpiSensorReadingValue = ASN_OCTET_STR */
            memcpy(row_ctx->saHpiSensorReadingNormalMinValue,var->val.string,var->val_len);
            row_ctx->saHpiSensorReadingNormalMinValue_len = var->val_len;
        break;

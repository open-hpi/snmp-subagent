...
saHpiSoftwareEventTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiSoftwareEventTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
init_saHpiSoftwareEventTable(void)
{
     ...
     *
     * saHpiSoftwareEventTable_context * new_row = create_row(index);
                         ...
                         saHpiSoftwareEventTable_context * src)
{
    ...
    memcpy( dst->saHpiSoftwareEventTimestamp, src->saHpiSoftwareEventTimestamp, src->saHpiSoftwareEventTimestamp_len );
    ...
    dst->saHpiSoftwareEventDelete = src->saHpiSoftwareEventDelete;
...
saHpiSoftwareEventTable_extract_index( saHpiSoftwareEventTable_context * ctx, netsnmp_index * hdr )
{
    ...
    netsnmp_variable_list var_saHpiSoftwareEventTimestamp;
    int err;
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
              ...
              /** skipping external index saHpiEventHistorical */
                ...
                if(var_saHpiSoftwareEventTimestamp.val_len > sizeof(ctx->saHpiSoftwareEventTimestamp))
                   err = -1;
                else
                    memcpy( ctx->saHpiSoftwareEventTimestamp, var_saHpiSoftwareEventTimestamp.val.string, var_saHpiSoftwareEventTimestamp.val_len );
...
saHpiSoftwareEventTable_create_row( netsnmp_index* hdr)
{
     ...
     */
    /**
     ctx->saHpiSoftwareEventDelete = 0;
    */
...
void saHpiSoftwareEventTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISOFTWAREEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiSoftwareEventDelete));
        break;
...
void saHpiSoftwareEventTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPISOFTWAREEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiSoftwareEventDelete = *var->val.integer;
        break;
...
initialize_table_saHpiSoftwareEventTable(void)
{
     ...
     */
        ...
        netsnmp_table_helper_add_index(table_info, ASN_INTEGER);
        /** index: saHpiSoftwareEventTimestamp */
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPISOFTWAREEVENTTIMESTAMP:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         ...
                         context->saHpiSoftwareEventTimestamp_len );
        break;
        ...
        case COLUMN_SAHPISOFTWAREEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiSoftwareEventDelete,
                         sizeof(context->saHpiSoftwareEventDelete) );
        break;

...
saHpiSensorThdPosHysteresisTable_set_reserve1 (netsnmp_request_group * rg)
{
  saHpiSensorThdPosHysteresisTable_context *row_ctx =
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdPosHysteresisTable_set_reserve1. Entry.\n"));
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdPosHysteresisTable_set_reserve1. Exit. (rc:%d) \n",rc));
}
...
saHpiSensorThdPosHysteresisTable_set_reserve2 (netsnmp_request_group * rg)
{
 saHpiSensorThdPosHysteresisTable_context *row_ctx =
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdPosHysteresisTable_set_reserve2. Entry.\n"));
    for (current = rg->list; current; current = current->next) {
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdPosHysteresisTable_set_reserve2. Exit (rc:%d).\n",rc));
}
...
saHpiSensorThdPosHysteresisTable_set_action (netsnmp_request_group * rg)
{
 netsnmp_variable_list *var;
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdPosHysteresisTable_set_action. Entry\n")); 
    for (current = rg->list; current; current = current->next) {
        ...
        case COLUMN_SAHPISENSORTHDPOSHYSTERESISICALINTERPRETED:
            ...
            row_ctx->saHpiSensorThdPosHysteresisInterpreted_len =
                var->val_len;
	    if (set_ThdPosHysteresis(row_ctx) != AGENT_ERR_NOERROR)
	      rc = SNMP_ERR_GENERR;
    ...
    DEBUGMSGTL((AGENT,"saHpiSensorThdPosHysteresisTable_set_action. Exit (rc: %d)\n",rc)); 
}

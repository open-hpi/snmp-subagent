...
saHpiDomainEventLogTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiDomainEventLogTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
init_saHpiDomainEventLogTable(void)
{
     ...
     *
     * saHpiDomainEventLogTable_context * new_row = create_row(index);
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiDomainEventLogTable_extract_index index list not implemented!\n" );
    return 0;
#else

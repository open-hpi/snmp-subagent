...
saHpiAnnouncementTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiAnnouncementTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
init_saHpiAnnouncementTable(void)
{
     ...
     *
     * saHpiAnnouncementTable_context * new_row = create_row(index);
                         ...
                         saHpiAnnouncementTable_context * src)
{
    ...
    dst->saHpiAnnuoncementTimestamp = src->saHpiAnnuoncementTimestamp;

    dst->saHpiAnnuoncementAddedByUser = src->saHpiAnnuoncementAddedByUser;

    dst->saHpiAnnouncementSeverity = src->saHpiAnnouncementSeverity;

    dst->saHpiAnnuoncementAcknowledged = src->saHpiAnnuoncementAcknowledged;
...
saHpiAnnouncementTable_create_row( netsnmp_index* hdr)
{
    ...
    /**
     ...
     ctx->saHpiAnnuoncementAcknowledged = 0;
...
void saHpiAnnouncementTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIANNUONCEMENTACKNOWLEDGED:
            /** TruthValue = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiAnnuoncementAcknowledged));
        break;
...
void saHpiAnnouncementTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIANNUONCEMENTACKNOWLEDGED:
            /** TruthValue = ASN_INTEGER */
            row_ctx->saHpiAnnuoncementAcknowledged = *var->val.integer;
        break;
            ...
            netsnmp_table_request_info *table_info )
{
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIANNUONCEMENTTIMESTAMP:
            /** SaHpiTime = ASN_COUNTER64 */
            snmp_set_var_typed_value(var, ASN_COUNTER64,
                         (char*)&context->saHpiAnnuoncementTimestamp,
                         sizeof(context->saHpiAnnuoncementTimestamp) );
        break;
    
        case COLUMN_SAHPIANNUONCEMENTADDEDBYUSER:
            /** TruthValue = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiAnnuoncementAddedByUser,
                         sizeof(context->saHpiAnnuoncementAddedByUser) );
        break;
        ...
        case COLUMN_SAHPIANNUONCEMENTACKNOWLEDGED:
            /** TruthValue = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiAnnuoncementAcknowledged,
                         sizeof(context->saHpiAnnuoncementAcknowledged) );
        break;

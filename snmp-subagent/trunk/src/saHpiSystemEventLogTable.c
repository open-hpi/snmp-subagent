      ...
      if (event_entry != NULL)
	{
	   ...
	   */
	      build_state_string(sensor.EventCategory, 
				 sensor.EventState,
				 (char *) &ctx->saHpiSystemEventLogSensorState,
				 &ctx->saHpiSystemEventLogSensorState_len,
	  ...
	  build_reading_strings(&sensor.TriggerReading,
				...
				ctx->saHpiSystemEventLogSensorTriggerReadingInterpreted,
				&ctx->saHpiSystemEventLogSensorTriggerReadingInterpreted_len,
				EVENT_TRIGGER_READING_INTERPRETED_MAX,
				&ctx->saHpiSystemEventLogSensorTriggerReadingEventStateFlag,
				ctx->saHpiSystemEventLogSensorTriggerReadingEventState,
	  ...
	  build_reading_strings(&sensor.TriggerThreshold,
				sensor.EventCategory,
				&ctx->saHpiSystemEventLogSensorTriggerThresholdType,
				&ctx->saHpiSystemEventLogSensorTriggerThresholdRaw,
				ctx->saHpiSystemEventLogSensorTriggerThresholdInterpreted,
				&ctx->saHpiSystemEventLogSensorTriggerThresholdInterpreted_len,
				EVENT_TRIGGER_THRESHOLD_INTERPRETED_MAX,
				&ctx->saHpiSystemEventLogSensorTriggerThresholdEventStateFlag,
				ctx->saHpiSystemEventLogSensorTriggerThresholdEventState,
				&ctx->saHpiSystemEventLogSensorTriggerThresholdEventState_len,
				EVENT_SENSOR_STATE_MAX);
	      ...
	      build_state_string(sensor.EventCategory, 
				 ...
				 &ctx->saHpiSystemEventLogSensorPreviousState_len,
				 SEL_SENSOR_STATE_MAX);
				   ...
				   saHpiSystemEventLogTable_context * src)
{
  ...
  dst->index.len = src->index.len;
    ...
    memcpy(dst->saHpiSystemEventLogSensorState,
           src->saHpiSystemEventLogSensorState,
           src->saHpiSystemEventLogSensorState_len);
    dst->saHpiSystemEventLogSensorState_len =
        src->saHpiSystemEventLogSensorState_len;
    ...
    dst->saHpiSystemEventLogSensorTriggerReadingEventStateFlag =
        src->saHpiSystemEventLogSensorTriggerReadingEventStateFlag;
    ...
    dst->saHpiSystemEventLogSensorTriggerThresholdEventStateFlag =
        src->saHpiSystemEventLogSensorTriggerThresholdEventStateFlag;
    ...
    memcpy(dst->saHpiSystemEventLogSensorPreviousState,
           src->saHpiSystemEventLogSensorPreviousState,
           src->saHpiSystemEventLogSensorPreviousState_len);
    dst->saHpiSystemEventLogSensorPreviousState_len =
        src->saHpiSystemEventLogSensorPreviousState_len;
...
saHpiSystemEventLogTable_set_reserve1 (netsnmp_request_group * rg)
{
  ...
  for (current = rg->list; current; current = current->next)
	...
	case COLUMN_SAHPISYSTEMEVENTLOGSENSORSTATE:
	...
	case COLUMN_SAHPISYSTEMEVENTLOGSENSORTRIGGERREADINGEVENTSTATEFLAG:
	...
	case COLUMN_SAHPISYSTEMEVENTLOGSENSORTRIGGERTHRESHOLDEVENTSTATEFLAG:
  ...
  switch (table_info->colnum)
    ...
    case COLUMN_SAHPISYSTEMEVENTLOGSENSORSTATE:
        ...
        snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                 (char *) &context->
                                 saHpiSystemEventLogSensorState,
                                 context->
                                 saHpiSystemEventLogSensorState_len);
        break;
    ...
    case COLUMN_SAHPISYSTEMEVENTLOGSENSORPREVIOUSSTATE:
        ...
        snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                 ...
                                 saHpiSystemEventLogSensorPreviousState,
                                 context->
                                 saHpiSystemEventLogSensorPreviousState_len);
        break;

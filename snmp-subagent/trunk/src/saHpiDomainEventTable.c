...
saHpiDomainEventTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiDomainEventTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
...
init_saHpiDomainEventTable(void)
{
     ...
     *
     * saHpiDomainEventTable_context * new_row = create_row(index);
                         ...
                         saHpiDomainEventTable_context * src)
{
    ...
    memcpy( dst->saHpiDomainEventTimestamp, src->saHpiDomainEventTimestamp, src->saHpiDomainEventTimestamp_len );
    dst->saHpiDomainEventTimestamp_len = src->saHpiDomainEventTimestamp_len;

    dst->saHpiDomainEventType = src->saHpiDomainEventType;

    dst->saHpiDomainEventDelete = src->saHpiDomainEventDelete;
...
saHpiDomainEventTable_extract_index( saHpiDomainEventTable_context * ctx, netsnmp_index * hdr )
{
    ...
    netsnmp_variable_list var_saHpiDomainEventTimestamp;
    int err;
...
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiDomainEventTable_extract_index index list not implemented!\n" );
    return 0;
#else
    ...
    return 0;
       ...
       memset( &var_saHpiDomainEventTimestamp, 0x00, sizeof(var_saHpiDomainEventTimestamp) );
       var_saHpiDomainEventTimestamp.type = ASN_OCTET_STR; /* type hint for parse_oid_indexes */
       /** TODO: link this index to the next, or NULL for the last one */
#ifdef TABLE_CONTAINER_TODO
    snmp_log(LOG_ERR, "saHpiDomainEventTable_extract_index index list not implemented!\n" );
    return 0;
#else
       var_saHpiDomainEventTimestamp.next_variable = &var_XX;
#endif
    ...
    if (err == SNMP_ERR_NOERROR) {
        ...
        */
              ...
              /** skipping external index saHpiEventHistorical */
                ...
                if(var_saHpiDomainEventTimestamp.val_len > sizeof(ctx->saHpiDomainEventTimestamp))
                   err = -1;
                else
                    memcpy( ctx->saHpiDomainEventTimestamp, var_saHpiDomainEventTimestamp.val.string, var_saHpiDomainEventTimestamp.val_len );
                ctx->saHpiDomainEventTimestamp_len = var_saHpiDomainEventTimestamp.val_len;
          ...
          */
            ...
            * TODO: check index for valid values. For EXAMPLE:
            *
              * if ( XXX_check_value( var_saHpiDomainEventTimestamp.val.string, XXX ) ) {
          *    err = -1;
          * }
          */
    }
...
void saHpiDomainEventTable_set_reserve1( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIDOMAINEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiDomainEventDelete));
        break;
...
void saHpiDomainEventTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIDOMAINEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiDomainEventDelete = *var->val.integer;
        break;
...
initialize_table_saHpiDomainEventTable(void)
{
     ...
     */
        ...
        netsnmp_table_helper_add_index(table_info, ASN_INTEGER);
        /** index: saHpiDomainEventTimestamp */
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIDOMAINEVENTTIMESTAMP:
            ...
            snmp_set_var_typed_value(var, ASN_OCTET_STR,
                         (char*)&context->saHpiDomainEventTimestamp,
                         context->saHpiDomainEventTimestamp_len );
        break;
    
        case COLUMN_SAHPIDOMAINEVENTTYPE:
            /** INTEGER = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiDomainEventType,
        ...
        case COLUMN_SAHPIDOMAINEVENTDELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiDomainEventDelete,
                         sizeof(context->saHpiDomainEventDelete) );
        break;

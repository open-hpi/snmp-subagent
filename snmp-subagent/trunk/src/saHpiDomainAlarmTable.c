...
saHpiDomainAlarmTable_cmp( const void *lhs, const void *rhs )
{
    ...
    snmp_log(LOG_ERR,
             "saHpiDomainAlarmTable_compare not implemented! Container order undefined\n" );
    return 0;
#endif
                         ...
                         saHpiDomainAlarmTable_context * src)
{
    ...
    dst->saHpiDomainAlarmDelete = src->saHpiDomainAlarmDelete;
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIDOMAINALARMID:
            ...
            rc = netsnmp_check_vb_type_and_size(var, ASN_UNSIGNED,
                                                sizeof(row_ctx->saHpiDomainAlarmId));
        break;
        ...
        case COLUMN_SAHPIDOMAINALARMDELETE:
            /** RowStatus = ASN_INTEGER */
            rc = netsnmp_check_vb_type_and_size(var, ASN_INTEGER,
                                                sizeof(row_ctx->saHpiDomainAlarmDelete));
        break;
        ...
        case COLUMN_SAHPIDOMAINALARMDELETE:
            /** RowStatus = ASN_INTEGER */
                rc = netsnmp_check_vb_rowstatus(current->ri->requestvb,
                                                undo_ctx ?
                                                undo_ctx->saHpiDomainAlarmDelete:0);
...
void saHpiDomainAlarmTable_set_action( netsnmp_request_group *rg )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        case COLUMN_SAHPIDOMAINALARMID:
            /** SaHpiInstrumentId = ASN_UNSIGNED */
            row_ctx->saHpiDomainAlarmId = *var->val.integer;
        break;
        ...
        case COLUMN_SAHPIDOMAINALARMDELETE:
            /** RowStatus = ASN_INTEGER */
            row_ctx->saHpiDomainAlarmDelete = *var->val.integer;
        break;
            ...
            netsnmp_table_request_info *table_info )
{
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIDOMAINALARMDELETE:
            /** RowStatus = ASN_INTEGER */
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (char*)&context->saHpiDomainAlarmDelete,
                         sizeof(context->saHpiDomainAlarmDelete) );
        break;

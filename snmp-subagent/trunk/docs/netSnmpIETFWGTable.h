...
#include <net-snmp/agent/table_array.h>
     ...
     */
        ...
        unsigned char   nsIETFWGName[65535];
        long            nsIETFWGName_len;

        /** OCTETSTR = ASN_OCTET_STR */
        unsigned char   nsIETFWGChair1[65535];
        long            nsIETFWGChair1_len;

        /** OCTETSTR = ASN_OCTET_STR */
        unsigned char   nsIETFWGChair2[65535];
 ...
 */
    ...
    const netSnmpIETFWGTable_context
        *netSnmpIETFWGTable_get_by_idx_rs(netsnmp_index *, int row_status);
    int             netSnmpIETFWGTable_get_value(netsnmp_request_info *,
                                                 netsnmp_index *,
                                                 netsnmp_table_request_info
                                                 *);
   void send_notification(unsigned int reg, void *);
   void create_(unsigned int reg, void *);
   void delete_(unsigned int reg, void *);
...
//#define netSnmpIETFWGTable_IDX2
    ...
    int            
        netSnmpIETFWGTable_can_delete(netSnmpIETFWGTable_context *
                                      undo_ctx,
    ...
    netSnmpIETFWGTable_context *netSnmpIETFWGTable_get(const char *name,
                                                       int len);
#endif

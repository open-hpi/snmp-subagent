...
oid saHpiSensorThdLowCriticalTable_oid[] =
  { saHpiSensorThdLowCriticalTable_TABLE_OID };
size_t saHpiSensorThdLowCriticalTable_oid_len =
OID_LENGTH (saHpiSensorThdLowCriticalTable_oid);
			   ...
			   SaHpiSensorNumT sensor_num)
{
  ...
  DEBUGMSGTL ((AGENT, "delete_ThdLowCritical_row (%d, %d, %d). Entry.\n",
  ...
  if (ctx)
    {
      ...
      saHpiSensorThdLowCriticalTable_delete_row (ctx);
      rc = AGENT_ERR_NOERROR;
    }
  DEBUGMSGTL ((AGENT, "delete_ThdLowCritical_row. Exit (rc: %d).\n", rc));
  return rc;
}
			 ...
			 SaHpiSensorReadingT * reading)
{
  ...
  DEBUGMSGT ((AGENT, "\t--- populate_ThdLowCritical, Entry,\n"));
  ...
  if (reading && threshold_def)
	...
	{
	  snmp_log (LOG_ERR,
		    "Not enough memory for a sensor ThdLowCritical row!");
	  return AGENT_ERR_INTERNAL_ERROR;
	}

      if (modify_saHpiSensorThdLowCriticalTable_row (domain_id,
						     resource_id,
						     sensor_id,
						     threshold_def,
						     reading,
  ...
  DEBUGMSGT ((AGENT, "\t--- populate_ThdLowCritical, Exit (rc: %d),\n", rc));
					   ...
					   * ctx)
{
  ...
  DEBUGMSGTL ((AGENT, "Modify saHpiSensorThdLowCriticalTable_ctx: Entry.\n"));
  ...
  if (ctx)
      ...
      if (ctx->hash != 0)
	{
	  ...
	  if ((ctx->domain_id == domain_id) &&
	      ...
	      (ctx->sensor_id == sensor_num))
	    {
	      ...
	      DEBUGMSGTL ((AGENT,
			   "Updating ThdLowCriticalTable row [%d, %d, %d]\n",
			   domain_id, resource_id, sensor_num));
	    }
	}
	...
	hash = 1;		/* Need this - we consider hash
      ...
      build_reading_strings (reading,
			     0,
			     &ctx->saHpiSensorThdLowCriticalValuesPresent,
  ...
  DEBUGMSGTL ((AGENT,
	       "Modify saHpiSensorThdLowCriticalTable_ctx: Exit (NULL DATA)"));
...
set_ThdLowCritical (saHpiSensorThdLowCriticalTable_context * ctx)
{
  ...
  DEBUGMSGTL ((AGENT, "set_ThdLowCritical: Entry.\n"));
  if (ctx)
    {
      ...
      if (rc != SA_OK)
	{
      ...
      build_reading_strings (&thd.LowCritical,
			     0,
			     &ctx->saHpiSensorThdLowCriticalValuesPresent,
			     &ctx->saHpiSensorThdLowCriticalRaw,
			     ctx->saHpiSensorThdLowCriticalInterpreted,
 ...
 */
static int
  saHpiSensorThdLowCriticalTable_row_copy
  (saHpiSensorThdLowCriticalTable_context * dst,
 ...
 */
netsnmp_index *saHpiSensorThdLowCriticalTable_delete_row
  (saHpiSensorThdLowCriticalTable_context * ctx)
{
  /*
 ...
 */
void
saHpiSensorThdLowCriticalTable_set_commit (netsnmp_request_group * rg)
{
 ...
 */
void
saHpiSensorThdLowCriticalTable_set_free (netsnmp_request_group * rg)
{
 ...
 */
void
saHpiSensorThdLowCriticalTable_set_undo (netsnmp_request_group * rg)
{
...
initialize_table_saHpiSensorThdLowCriticalTable (void)
{
  ...
  if (my_handler)
    {
      snmp_log (LOG_ERR,
		"initialize_table_saHpiSensorThdLowCriticalTable_handler called again\n");
      return;
    }
  ...
  my_handler =
    ...
    ("saHpiSensorThdLowCriticalTable",
     ...
     saHpiSensorThdLowCriticalTable_oid_len, HANDLER_CAN_RWRITE);
  ...
  cb.container =
    netsnmp_container_find ("saHpiSensorThdLowCriticalTable_primary:"
			    "saHpiSensorThdLowCriticalTable:"
			    "table_container");
  ...
  cb.duplicate_row =
    (UserRowMethod *) saHpiSensorThdLowCriticalTable_duplicate_row;
  cb.delete_row = (UserRowMethod *) saHpiSensorThdLowCriticalTable_delete_row;
  cb.row_copy =
    (Netsnmp_User_Row_Operation *) saHpiSensorThdLowCriticalTable_row_copy;

  cb.can_delete =
    (Netsnmp_User_Row_Action *) saHpiSensorThdLowCriticalTable_can_delete;
 ...
 */
int
saHpiSensorThdLowCriticalTable_get_value (netsnmp_request_info * request,
					  netsnmp_index * item,

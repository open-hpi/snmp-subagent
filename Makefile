...
TARGETS=hpiSubagent
OBJ=saHpiEventTable.o saHpiSystemEventLogTable.o saHpiWatchdogTable.o saHpiSensorTable.o saHpiInventoryTable.o saHpiCtrlTable.o hpiSubagent.o saHpiTable.o saHpiRdrTable.o epath_utils.o alarm.o
